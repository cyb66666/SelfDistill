...
# ==================== Paths ====================
# 数据源：mgrs = text_info.json + global_imgs；rs3 = .tar WebDataset
DATASET="mgrs"
MGRS_JSON="/root/data/mgrs/text_info.json"
MGRS_IMG_ROOT="/root/data/mgrs/global_imgs"
RS3_TAR_DIR="/root/data/rs3_filtered"
RS3_VAL_DIR="/root/data/rs3_filtered"
MODEL_NAME="ViT-B-32"
BASE_MODEL_TYPE="clip"  # remoteclip | georsclip | clip | custom
